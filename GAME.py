...
class Block:
    def __init__(self, posx, posy, width, height, color):
        ...
        # The BLUE blocks have the health of 200. So,
...
def gameOver():
    gameOver = True
    font = pygame.font.SysFont('freesansbold.ttf', 50,italic=True)  # Create a font object with size 50
...
def main():
    ...
    striker = Striker(0, HEIGHT - 50, 100, 20, 10,BLUE)
    strikerXFac = 0

    ball = Ball(0, HEIGHT - 150, 7, 5, BLACK)
